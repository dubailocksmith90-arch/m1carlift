                    ...
                    <div className="lg:col-span-2">
                      ...
                      <div className="flex flex-wrap items-center gap-4">
                        <a
                          ...
                          className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1EBE5B] text-white font-bold text-sm px-6 py-3 rounded-lg transition-all duration-200 shadow-[0_0_16px_rgba(37,211,102,0.25)]"
                        >
